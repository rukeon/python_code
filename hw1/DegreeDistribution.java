...
public class DegreeDistribution extends Configured implements Tool {
    ...
    public static class DegreeDistributionMapper extends Mapper<LongWritable, Text, IntWritable, IntWritable>{
        ...
        public void map(final LongWritable key, final Text value, final Context context) throws IOException, InterruptedException{
            ...
            word.set(Integer.parseInt(splitData[1]));
            context.write(word, ONE);
        }
    }

    public static class DegreeDistributionReducer extends Reducer<IntWritable, IntWritable, IntWritable, IntWritable> {
    ...
    public int run(final String[] args) throws Exception {
        ...
        final Job job = Job.getInstance(conf, "Degree Distribution");
    ...
    public static void main(final String[] args) throws Exception {
        final int returnCode = ToolRunner.run(new Configuration(), new DegreeDistribution(), args);
